...
public class PanelDetallesRestaurante extends JPanel {
    ...
    public PanelDetallesRestaurante() {
        ...
        panelAuxiliar.add(lblCalificacion);
        labCalificacion = new JLabel();
        panelAuxiliar.add(labCalificacion);
        add(panelAuxiliar);
        ...
        panelAuxiliar.add(lblVisitado);
        chkVisitado = new JCheckBox();
        panelAuxiliar.add(chkVisitado);
        add(panelAuxiliar);
